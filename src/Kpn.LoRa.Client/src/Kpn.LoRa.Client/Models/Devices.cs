namespace Kpn.LoRa.Client.Core.Models.Devices
{
...
namespace Kpn.LoRa.Client.Core.Models.DeviceViewModel
{
	public class Device
	{
		public string href { get; set; }
...
namespace Kpn.LoRa.Client.Core.Models.DeviceAddModel
{
	public class Device
	{
		public string name { get; set; }
...
namespace Kpn.LoRa.Client.Core.Models.DeviceUpdateModel
{
	public class Device
	{
		public string name { get; set; }
